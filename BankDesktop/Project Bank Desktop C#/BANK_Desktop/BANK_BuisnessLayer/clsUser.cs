...
namespace BANK_BuisnessLayer
{
    ...
    {
        public enum enPermissions {pAll=-1,pPeople=1,pUser=2,pClient=4, pWithdrawDeposit= 8, pTransfer= 16, pCurrencyCalucator = 32, pAddCurrency=64, pCurrencyExchangeList=128 }
