...
namespace BANKDataAccessLayer
{
    public class clsPersonData
    {
        ...
        public static DataTable GetAllPeople()
        {
            ...
            SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString);
            string query = "SELECT PersonID,FirstName,LastName ,Phone,Email,Case when People.Gendor=0 then 'Male' when People.Gendor=1 then 'Female' END  AS Gendor    ,DateBirth     ,ImagePath     ,Countries.CountryName as Nationality      ,NationalNO  FROM People inner join  Countries ON Countries.CountryID=People.NationalCountryID";
            SqlCommand command = new SqlCommand(query,connection);
